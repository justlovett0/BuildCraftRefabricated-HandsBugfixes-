...
public class BCCoreStatements {
   ...
   public static final TriggerMachine[] TRIGGER_MACHINE = new TriggerMachine[]{TRIGGER_MACHINE_ACTIVE, TRIGGER_MACHINE_INACTIVE};
   ...
   public static final TriggerRedstoneInput[] TRIGGER_REDSTONE = new TriggerRedstoneInput[]{TRIGGER_REDSTONE_ACTIVE, TRIGGER_REDSTONE_INACTIVE};
   public static final ActionRedstoneOutput ACTION_REDSTONE = new ActionRedstoneOutput();
   public static final ActionMachineControl ACTION_MACHINE_CONTROL_OFF = new ActionMachineControl(IControllable.Mode.OFF);
   public static final ActionMachineControl ACTION_MACHINE_CONTROL_ON = new ActionMachineControl(IControllable.Mode.ON);
   public static final ActionMachineControl ACTION_MACHINE_CONTROL_LOOP = new ActionMachineControl(IControllable.Mode.LOOP);
   public static final ActionMachineControl[] ACTION_MACHINE_CONTROL = new ActionMachineControl[]{
   ...
   public static final TriggerPower[] TRIGGER_POWER = new TriggerPower[]{TRIGGER_POWER_LOW, TRIGGER_POWER_HIGH};
   ...
   public static final TriggerInventory[] TRIGGER_INVENTORY = new TriggerInventory[]{
   ...
   public static final TriggerFluidContainer[] TRIGGER_FLUID = new TriggerFluidContainer[]{
   ...
   public static final TriggerInventoryLevel[] TRIGGER_INVENTORY_LEVEL = new TriggerInventoryLevel[]{
   ...
   public static final TriggerFluidContainerLevel[] TRIGGER_FLUID_LEVEL = new TriggerFluidContainerLevel[]{
      TRIGGER_FLUID_BELOW_25, TRIGGER_FLUID_BELOW_50, TRIGGER_FLUID_BELOW_75
   };
   public static final TriggerEnginePowerStage TRIGGER_POWER_BLUE = new TriggerEnginePowerStage(EnumPowerStage.BLUE);
   public static final TriggerEnginePowerStage TRIGGER_POWER_GREEN = new TriggerEnginePowerStage(EnumPowerStage.GREEN);
   public static final TriggerEnginePowerStage TRIGGER_POWER_YELLOW = new TriggerEnginePowerStage(EnumPowerStage.YELLOW);
   public static final TriggerEnginePowerStage TRIGGER_POWER_RED = new TriggerEnginePowerStage(EnumPowerStage.RED);
   public static final TriggerEnginePowerStage TRIGGER_POWER_OVERHEAT = new TriggerEnginePowerStage(EnumPowerStage.OVERHEAT);
   public static final TriggerEnginePowerStage[] TRIGGER_POWER_STAGES = new TriggerEnginePowerStage[]{
      TRIGGER_POWER_BLUE, TRIGGER_POWER_GREEN, TRIGGER_POWER_YELLOW, TRIGGER_POWER_RED, TRIGGER_POWER_OVERHEAT
   };
   public static final BCStatement[] TRIGGER_INVENTORY_ALL = new BCStatement[7];
   public static final BCStatement[] TRIGGER_FLUID_ALL = new BCStatement[7];
