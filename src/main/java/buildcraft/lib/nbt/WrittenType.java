...
public enum WrittenType {
   ...
   public static final WrittenType[] ORDERED_VALUES = new WrittenType[]{BYTE, SHORT, MEDIUM, INT};
   ...
   public void writeIndex(DataOutput out, int index) throws IOException {
      if (index > this.maxStorableValue) {
         throw new IllegalArgumentException("Tried to write a value that was too large! (" + index + " > " + this.maxStorableValue + " for " + this + ")");
      }
