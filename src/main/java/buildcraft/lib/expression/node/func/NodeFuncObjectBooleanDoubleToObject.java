...
public class NodeFuncObjectBooleanDoubleToObject<A, R> extends NodeFuncBase implements INodeFunc.INodeFuncObject<R> {
   public final NodeFuncObjectBooleanDoubleToObject.IFuncObjectBooleanDoubleToObject<A, R> function;
   private final StringFunctionQuad stringFunction;
   private final Class<A> argTypeA;
   private final Class<R> returnType;

   public NodeFuncObjectBooleanDoubleToObject(
      String name, Class<A> argTypeA, Class<R> returnType, NodeFuncObjectBooleanDoubleToObject.IFuncObjectBooleanDoubleToObject<A, R> function
   ) {
      this(
         argTypeA,
         returnType,
   ...
   public NodeFuncObjectBooleanDoubleToObject(
      Class<A> argTypeA,
      Class<R> returnType,
      NodeFuncObjectBooleanDoubleToObject.IFuncObjectBooleanDoubleToObject<A, R> function,
   ...
   public NodeFuncObjectBooleanDoubleToObject<A, R>.FuncObjectBooleanDoubleToObject create(
      IExpressionNode.INodeObject<A> argA, IExpressionNode.INodeBoolean argB, IExpressionNode.INodeDouble argC
   ) {
   ...
   public class FuncObjectBooleanDoubleToObject implements IExpressionNode.INodeObject<R>, IDependantNode, NodeFuncBase.IFunctionNode {
      ...
      public IExpressionNode.INodeObject<R> inline() {
         return !NodeFuncObjectBooleanDoubleToObject.this.canInline
            ? NodeInliningHelper.tryInline(
               this,
               this.argA,
               this.argB,
               this.argC,
               (a, b, c) -> NodeFuncObjectBooleanDoubleToObject.this.new FuncObjectBooleanDoubleToObject(a, b, c),
               (a, b, c) -> NodeFuncObjectBooleanDoubleToObject.this.new FuncObjectBooleanDoubleToObject(a, b, c)
            )
            : NodeInliningHelper.tryInline(
               this,
               ...
               (a, b, c) -> new NodeConstantObject<>(
                  NodeFuncObjectBooleanDoubleToObject.this.returnType,
                  NodeFuncObjectBooleanDoubleToObject.this.function.apply(a.evaluate(), b.evaluate(), c.evaluate())
               )
            );
      }
      ...
      public void visitDependants(IDependancyVisitor visitor) {
         if (!NodeFuncObjectBooleanDoubleToObject.this.canInline) {
            if (NodeFuncObjectBooleanDoubleToObject.this.function instanceof IDependantNode) {
               visitor.dependOn((IDependantNode)NodeFuncObjectBooleanDoubleToObject.this.function);
            } else {
      ...
      public boolean equals(Object obj) {
         if (obj == this) {
            ...
            NodeFuncObjectBooleanDoubleToObject<A, R>.FuncObjectBooleanDoubleToObject other = (NodeFuncObjectBooleanDoubleToObject.FuncObjectBooleanDoubleToObject)obj;
   ...
   public interface IFuncObjectBooleanDoubleToObject<A, R> {
      R apply(A var1, boolean var2, double var3);
   }
}
