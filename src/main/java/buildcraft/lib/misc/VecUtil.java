...
public class VecUtil {
   ...
   public static final Vec3 VEC_ONE = new Vec3(1.0, 1.0, 1.0);
   ...
   public static Vec3 replaceValue(Vec3 old, Axis axis, double with) {
      return new Vec3(axis == Axis.X ? with : old.x, axis == Axis.Y ? with : old.y, axis == Axis.Z ? with : old.z);
   }

   @Nonnull
   public static BlockPos replaceValue(Vec3i old, Axis axis, int with) {
      return new BlockPos(axis == Axis.X ? with : old.getX(), axis == Axis.Y ? with : old.getY(), axis == Axis.Z ? with : old.getZ());
   }
   ...
   public static double getValue(Vec3 negative, Vec3 positive, Direction face) {
      switch (face) {
         ...
         case EAST:
            return positive.x;
         default:
            throw new IllegalArgumentException("Unknown Direction " + face);
      }
   }
   ...
   public static BlockPos min(BlockPos a, BlockPos b) {
      if (a == null) {
         ...
         return b == null ? a : new BlockPos(Math.min(a.getX(), b.getX()), Math.min(a.getY(), b.getY()), Math.min(a.getZ(), b.getZ()));
      }
   }
   ...
   public static BlockPos max(BlockPos a, BlockPos b) {
      if (a == null) {
         ...
         return b == null ? a : new BlockPos(Math.max(a.getX(), b.getX()), Math.max(a.getY(), b.getY()), Math.max(a.getZ(), b.getZ()));
      }
   }
   ...
   public static Vec3 min(Vec3 a, Vec3 b) {
      if (a == null) {
         ...
         return b == null ? a : new Vec3(Math.min(a.x, b.x), Math.min(a.y, b.y), Math.min(a.z, b.z));
      }
   }
   ...
   public static Vec3 max(Vec3 a, Vec3 b) {
      if (a == null) {
         ...
         return b == null ? a : new Vec3(Math.max(a.x, b.x), Math.max(a.y, b.y), Math.max(a.z, b.z));
      }
   }
