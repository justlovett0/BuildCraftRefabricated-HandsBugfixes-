...
public record TooltipBlueprintPipRenderState(
   ...
   public TooltipBlueprintPipRenderState(Snapshot snapshot, int x0, int y0, int x1, int y1, float scale, @Nullable ScreenRectangle scissorArea) {
