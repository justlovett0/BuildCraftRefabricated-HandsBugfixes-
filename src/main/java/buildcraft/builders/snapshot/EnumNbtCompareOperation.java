...
public enum EnumNbtCompareOperation {
   EQ("=") {
      ...
      public boolean compare(Tag a, Tag b) {
         return Objects.equals(EnumNbtCompareOperation.GSON.toJson(a, Tag.class), EnumNbtCompareOperation.GSON.toJson(b, Tag.class));
      }
   },
   NQE("!=") {
      @Override
   ...
   public static final JsonDeserializer<EnumNbtCompareOperation> DESERIALIZER = (json, typeOfT, context) -> byName(json.getAsJsonPrimitive().getAsString());
   ...
   public abstract boolean compare(Tag var1, Tag var2);
}
