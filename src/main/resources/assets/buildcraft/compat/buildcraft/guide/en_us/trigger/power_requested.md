...
<no_lore>
Power Requested is a gate trigger provided on any gate placed on a Kinesis Pipe or Energy Pipe.
</no_lore>
...
The trigger reads the live power-request value from the pipe's flow handler. It works on both MJ kinesis pipes and Energy Pipes — the flow handler reports requested-but-undelivered power for whichever flavour the pipe carries.
